...
:::concise
● Led investigation of computational rules for **CRISPRi guide RNA design**, using open-source machine learning algorithms.
...
● Integrated **single-cell epigenetic and transcriptomic data** to identify iPSC **gene regulatory networks**, which drive cell differentiation.

● Mentored junior programmers on the computational biology team.
:::
...
::: concise
● Quantifed and characterized **CRISPR gene modifications**, with both in-house and open-source tools for genomic data analysis.
...
Ultimate frisbee league player. San Francisco, CA. 2018 -- Present.
