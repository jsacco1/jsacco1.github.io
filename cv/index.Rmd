...
![dna cut](https://www.pinclipart.com/picdir/big/528-5286661_image-of-blue-dna-being-cleaved-in-half.png){width=60%} 
...
- Proficiency with **single cell gene expression, gene regulation, and epigenetic data analyses**, genomic data repositories, **machine learning**, experimental design, and CRISPR screening tools.
...
Self-motivated **computational biologist** with **seven years of both academic and industry experience** in: functional genomics, population genetics, and workflow automation. 

An analytical thinker and quick learner, with broad understanding of **statistical and machine learning methods**, **gene regulatory network inference**, and **multi-omic single cell data analysis**. Published author of  in the association of curated genotype and phenotype data to model **disease prevalence, and sub-types of Mendelian disorders**. Extensive experience in **AI** and **biomarker data analysis** to advance **cancer immunotherapy in clinical trials**. Advocate for diversity and inclusion in science.
